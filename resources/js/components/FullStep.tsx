...
import React, { Children, forwardRef, ForwardRefRenderFunction, ReactNode, useImperativeHandle, useState } from 'react'
...
const Steper: ForwardRefRenderFunction<FullStepRef, FullStepProps> = (
  { children, steps, onReset, onFinish, EndStepperComponent },
  ref,
) => {
...
export const FullSteper = forwardRef(Steper)
